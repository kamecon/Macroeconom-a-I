...
shinyUI(fluidPage(
  tabsetPanel(
    tabPanel("Paro", fluid=TRUE,
  headerPanel("Datos de Empleo (EUROSTAT)"),
  sidebarPanel(
    selectizeInput(
      "concepto", "Concepto",
                choices = c('Paro'="une_rt_a"
                            # ,'Empleo y actividad'="lfsi_emp_a",'Paro de larga duración'="une_ltu_a",
  ...
  #          headerPanel("Datos de Empleo (empleo)"),
  #          sidebarPanel(
  #            selectizeInput(
  #              "concepto", "Concepto",
  #              choices = c('Empleo y actividad'="lfsi_emp_a"
  #                # ,'Paro'="une_rt_a",'Paro de larga duración'="une_ltu_a",
  #                #           'Nivel de educación'="lfsi_educ_a",'Empleo temporal'="lfsi_pt_a"
  #                )
  #            ),
  #            selectizeInput(
  ...
  #            selectizeInput(
  #              "unidad", "Unidad",
  #              choices=c('% Población'="PC_POP")
  #            ),
  #            selectizeInput(
  #              "edad", "Edad",
  #              choices=c('Entre 15 y 64'="Y15-64")
  #            ),
  #            selectizeInput(
  #              "indicador", "Indicador",
  #              choices=c('Población activa'="ACT", 'Empleo'="EMP_LFS")
  #              #,multiple = TRUE, options = list(maxItems = 2)
  #            ),
  #            
  #            radioButtons('format', 'Formato del reporte', c('PDF'),
